...
# ✅ Versione stabile per Render + Telegram multi-chat + ping UptimeRobot
        ...
        for symbol in symbols[:MAX_CANDIDATES_PER_CYCLE]:
            for tf in FAST_TFS + SLOW_TFS:
                ...
                if abs(variation) >= threshold:
                    _, suggestion = estimate_risk_and_suggestion(closes, vols)
...
if __name__ == "__main__":
    ...
    send_telegram("🚀 Bot avviato con successo su Render — monitor Bybit attivo ✅")
