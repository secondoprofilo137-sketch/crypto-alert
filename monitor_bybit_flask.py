...
# Monitor Bybit con Flask + multi-chat Telegram + soglie aggiornate
...
# soglie aggiornate per timeframe
THRESHOLDS = {
    "1m": 7.5,
    "3m": 11.5,
    "1h": 17.0,
...
if __name__ == "__main__":
    print(f"🚀 Avvio monitor Bybit — timeframes {FAST_TFS + SLOW_TFS}, thresholds personalizzate: {THRESHOLDS}, loop {LOOP_DELAY}s")
